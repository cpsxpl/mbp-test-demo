 ...
 */
//@Service("planTask")
public class PlanTaskImpl extends SchedulerPlanImpl {
    ...
    public String queryExecutingJobList() throws Exception {
        ...
        for (String group : scheduler.getJobGroupNames()) {
            ...
            for (JobKey jobKey : scheduler.getJobKeys(GroupMatcher.<JobKey>groupEquals(group))) {
                logger.info("PlanTaskImpl.queryExecutingJobList jobKey:{}", jobKey);
                ...
                logger.info("PlanTaskImpl.queryExecutingJobList triggerState:{}", triggerState);
                // 获取正常运行的任务列表
     ...
     * @param cronExpression
     */
    public void updatePlan(Long planId, String jobId, String cronExpression) {
        TaskSchedulerContainer taskSchedulerContainer = TaskSchedulerContainer.getTaskSchedulerContainer(scheduler);
        taskSchedulerContainer.updateScheduleJob(Long.toString(planId), jobId, cronExpression);
    }
