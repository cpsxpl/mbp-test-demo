package com.mbp.eng.framework.redis.config;

import cn.hutool.core.util.StrUtil;
import com.mbp.eng.framework.redis.core.TimeoutRedisCacheManager;
...
import static com.mbp.eng.framework.redis.config.MbpRedisAutoConfiguration.buildRedisSerializer;

/**
 * Cache 配置类,基于 Redis 实现
 */
@AutoConfiguration
@EnableConfigurationProperties({CacheProperties.class, MbpCacheProperties.class})
@EnableCaching
public class MbpCacheAutoConfiguration {
