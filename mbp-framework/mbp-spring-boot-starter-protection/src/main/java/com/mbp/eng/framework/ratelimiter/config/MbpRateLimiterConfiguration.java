package com.mbp.eng.framework.ratelimiter.config;

import com.mbp.eng.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.mbp.eng.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.mbp.eng.framework.ratelimiter.core.keyresolver.impl.*;
import com.mbp.eng.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class MbpRateLimiterConfiguration {
