package com.mbp.eng.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.mbp.eng.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "MBP源码,牛逼！")
    @ExcelProperty("结果提示")
