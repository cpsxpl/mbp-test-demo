...
public class CodegenTableSaveReqVO {
    ...
    @Schema(description = "表描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "MBP")
    ...
    @Schema(description = "作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "MBP源码")
