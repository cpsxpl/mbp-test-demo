package com.mbp.eng.module.infra.websocket;
...
import com.mbp.eng.framework.websocket.core.sender.WebSocketMessageSender;
import com.mbp.eng.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.mbp.eng.module.infra.websocket.message.DemoReceiveMessage;
import com.mbp.eng.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 mbp.websocket.enable 配置项,可以关闭 WebSocket 的功能,所以这里只能不强制注入
