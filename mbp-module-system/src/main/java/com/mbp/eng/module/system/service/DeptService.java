...
public interface DeptService {
     ...
     * @return 部门列表
     */
    List<SystemDept> getDeptList(DeptListReqVO reqVO);
    ...
    default Map<Long, SystemDept> getDeptMap(Collection<Long> ids) {
        ...
        return CollectionUtils.convertMap(list, SystemDept::getId);
    }
     ...
     * @return 子部门列表
     */
    default List<SystemDept> getChildDeptList(Long id) {
     ...
     * @return 子部门列表
     */
    List<SystemDept> getChildDeptList(Collection<Long> ids);
     ...
     * @return 部门列表
     */
    List<SystemDept> getDeptListByLeaderUserId(Long id);
