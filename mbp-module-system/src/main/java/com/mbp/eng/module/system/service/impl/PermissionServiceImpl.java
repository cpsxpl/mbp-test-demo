...
import com.mbp.eng.framework.common.biz.system.permission.DeptDataPermissionRespDTO;
...
import com.mbp.eng.module.system.dataobject.permission.RoleMenuDO;
import com.mbp.eng.module.system.dataobject.permission.UserRoleDO;
import com.mbp.eng.module.system.enums.DataScopeEnum;
...
import com.mbp.eng.module.system.mapper.RoleMenuMapper;
import com.mbp.eng.module.system.mapper.UserRoleMapper;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    public DeptDataPermissionRespDTO getDeptDataPermission(Long userId) {
        ...
        Supplier<Long> userDeptId = Suppliers.memoize(() -> systemUsersService.getUser(userId).getDeptId());
        // 遍历每个角色，计算
