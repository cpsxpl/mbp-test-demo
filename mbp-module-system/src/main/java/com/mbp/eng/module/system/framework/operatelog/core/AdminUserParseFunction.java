package com.mbp.eng.module.system.framework.operatelog.core;
...
public class AdminUserParseFunction implements IParseFunction {
    ...
    @Resource
    private SystemUsersService adminUserService;
    ...
    public String apply(Object value) {
        ...
        // 获取用户信息
        SystemUsers user = adminUserService.getUser(Convert.toLong(value));
        if (user == null) {
