...
public interface DictDataService {
     ...
     * @return 字典数据全列表
     */
    List<SystemDictData> getDictDataList(@Nullable Integer status, @Nullable String dictType);
     ...
     * @return 字典数据分页列表
     */
    PageResult<SystemDictData> getDictDataPage(DictDataPageReqVO pageReqVO);
     ...
     * @return 字典数据
     */
    SystemDictData getDictData(Long id);
     ...
     * @return 字典数据
     */
    SystemDictData getDictData(String dictType, String value);
     ...
     * @return 字典数据
     */
    SystemDictData parseDictData(String dictType, String label);
