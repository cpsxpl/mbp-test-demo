package com.mbp.eng.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogRespVO implements VO {
    ...
    private Long userId;
    @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "MBP")
    @ExcelProperty("操作人")
    ...
    @Schema(description = "操作明细", example = "修改编号为 1 的用户信息,将性别从男改成女,将姓名从MBP改成源码。")
