package com.mbp.eng.module.system.controller.admin.user;
...
import com.mbp.eng.module.system.controller.admin.user.vo.user.*;
import com.mbp.eng.module.system.convert.user.UserConvert;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunaitest@gmail.com").mobile("13800138000")
                        .nickname("MBP").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("mbp").deptId(2L).email("mbptest@gmail.com").mobile("15601701300")
    ...
    @Parameter(name = "nickname", description = "昵称关键词", required = true, example = "MBP")
