package com.mbp.eng.module.system.convert.user;

import com.mbp.eng.framework.common.util.collection.CollectionUtils;
import com.mbp.eng.framework.common.util.collection.MapUtils;
import com.mbp.eng.framework.common.util.object.BeanUtils;
import com.mbp.eng.module.system.controller.admin.dept.vo.dept.DeptSimpleRespVO;
import com.mbp.eng.module.system.controller.admin.dept.vo.post.PostSimpleRespVO;
import com.mbp.eng.module.system.controller.admin.permission.vo.role.RoleSimpleRespVO;
import com.mbp.eng.module.system.controller.admin.user.vo.profile.UserProfileRespVO;
import com.mbp.eng.module.system.controller.admin.user.vo.user.UserRespVO;
import com.mbp.eng.module.system.controller.admin.user.vo.user.UserSimpleRespVO;
